sap.ui.define([
		...
		return BaseObject.extend("approve.req.vendor.codan.model.ListSelector", {
			 ...
			 * @return {approve.req.vendor.codan.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
