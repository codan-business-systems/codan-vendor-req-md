					...
					iChangeTheHashToObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								Opa5.getHashChanger().setHash("/Requests/" + aEntitySet[iObjIndex].id);
							}
						}));
					},
					...
					iShouldSeeTheHashForObjectN : function (iObjIndex) {
						return this.waitFor(this.createAWaitForAnEntitySet({
							...
							success : function (aEntitySet) {
								...
								Opa5.assert.strictEqual(sHash, "Requests/" + aEntitySet[iObjIndex].id, "The Hash is not correct");
							}
						}));
					},
						...
						return this.waitFor({
							success : function () {
								var sObjectId = this.getContext().currentItem.id,
									...
									sHash = oHashChanger.getHash();
								Opa5.assert.strictEqual(sHash, "Requests/" + sObjectId, "The Hash is not correct");
							}
						});
					},
