sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("approve/req/vendor/codan/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#VendorRequests-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#VendorRequests-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("approve.req.vendor.codan.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["approve/req/vendor/codan/localService/mockserver"], function (mockserver) {
